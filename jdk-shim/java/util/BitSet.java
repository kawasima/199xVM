...
public class BitSet implements Cloneable, java.io.Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return mismatch(words, 0, set.words, 0, wordsInUse) == -1;
    }
    ...
    public String toString() {
        ...
        final int MAX_INITIAL_CAPACITY = SOFT_MAX_ARRAY_LENGTH;
    ...
    private static int mismatch(long[] a, int aFrom, long[] b, int bFrom, int len) {
        for (int i = 0; i < len; i++) {
