...
public final class Arrays {
    ...
    public static boolean equals(long[] a, int aFromIndex, int aToIndex,
        ...
        { for (int i = 0; i < aLength; i++) { if (a[aFromIndex + i] != b[bFromIndex + i]) return false; } return true; }
    }
    ...
    public static int compare(boolean[] a, boolean[] b) {
        ...
        int i; { int _len = Math.min(a.length, b.length); i = -1; for (int _k = 0; _k < _len; _k++) { if (a[_k] != b[_k]) { i = _k; break; } } }
        if (i >= 0) {
            return Boolean.compare(a[i], b[i]);
        }
    ...
    public static int compare(boolean[] a, int aFromIndex, int aToIndex,
        ...
        int aLength = aToIndex - aFromIndex;
        int bLength = bToIndex - bFromIndex;
        int i; { int _len = Math.min(aLength, bLength); i = -1; for (int _k = 0; _k < _len; _k++) { if (a[aFromIndex + _k] != b[bFromIndex + _k]) { i = _k; break; } } }
        if (i >= 0) {
            return Boolean.compare(a[aFromIndex + i], b[bFromIndex + i]);
        }
    ...
    public static int mismatch(boolean[] a, boolean[] b) {
        ...
        int i; { i = -1; for (int _k = 0; _k < length; _k++) { if (a[_k] != b[_k]) { i = _k; break; } } }
    ...
    public static int mismatch(boolean[] a, int aFromIndex, int aToIndex,
        ...
        int bLength = bToIndex - bFromIndex;
        int length = Math.min(aLength, bLength);
        int i; { i = -1; for (int _k = 0; _k < length; _k++) { if (a[aFromIndex + _k] != b[bFromIndex + _k]) { i = _k; break; } } }
