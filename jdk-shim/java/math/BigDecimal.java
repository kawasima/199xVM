...
public class BigDecimal extends Number implements Comparable<BigDecimal> {
    ...
    private String layoutChars(boolean sci) {
        ...
        if (scale == 2  &&
            ...
            String low = lowInt < 10 ? "0" + lowInt : Integer.toString(lowInt);
            return Integer.toString(highInt) + "." + low;
        }
    ...
    // Serialization support is intentionally omitted in this VM shim.
