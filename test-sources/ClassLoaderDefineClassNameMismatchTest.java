public class ClassLoaderDefineClassNameMismatchTest {
    ...
    private static final class ExposedLoader extends ClassLoader {
        Class<?> defineNamed(String binaryName, byte[] bytes) {
    ...
    public static String run() {
        ...
        try {
            loader.defineNamed("wrong.Name", DEFINE_PROBE_CLASS_BYTES);
            return "no-exception";
